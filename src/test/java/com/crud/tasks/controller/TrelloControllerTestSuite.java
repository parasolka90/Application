...
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
    ...
    public class TrelloControllerTestSuite {
        ...
        public void shouldFetchTrelloBoards() throws Exception {
            ...
            trellLists.add(new TrelloListDto("1", "Test List", false));

            List<TrelloBoardDto> trelloBoards = new ArrayList<>();
            trelloBoards.add(new TrelloBoardDto("1", "Test task", trellLists));
        ...
        public void shouldCreateTrelloCard() throws Exception {
            ...
            TrelloCardDto trelloCardDto =
                    new TrelloCardDto("Test", "desc", "top", "1");
            CreatedTrelloDto createdTrelloCardDto =
                    new CreatedTrelloDto("323", "Test", "http://test.com");

            Mockito.when(trelloFacade.createTrello(ArgumentMatchers.any(TrelloCardDto.class)))
